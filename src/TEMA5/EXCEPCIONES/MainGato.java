...
public class MainGato {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Intentamos crear un gato con un nombre incorrecto (muy corto)
            gato2 = new Gato("X", 5);
        ...
        try {
            // Intentamos crear un gato con una edad negativa
